...
namespace IdesseCardTypes.Services
{
	...
	public class RazorPartialToStringRenderer : IRazorPartialToStringRenderer
	{
		...
		public RazorPartialToStringRenderer(IRazorViewEngine viewEngine, ITempDataProvider tempDataProvider,
		...
		private ActionContext GetActionContext()
		{
			...
			return new ActionContext(_ContextAccessor.HttpContext, _ContextAccessor.HttpContext.GetRouteData(),
